...
/** gnomad_get_coverage — depth + callability. positions[] for fine grain, summary for a gene. */
interface CoveragePoint {
  pos: number;
  mean: number; median: number;
  over_1: number; over_5: number; over_10: number; over_15: number;
  over_20: number; over_25: number; over_30: number; over_50: number; over_100: number; // fraction 0–1
}
```
